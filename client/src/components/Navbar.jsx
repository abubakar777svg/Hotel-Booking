...
const BookIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth="2"
      d="M5 19V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z"
    ></path>
  </svg>
);
const Navbar = () => {
    ...
    >
      ...
      <div className="flex items-center gap-3 md:hidden cursor-pointer">
        ...
        <img
          ...
          className={`w-6 h-6 ${isScrolled && "invert"}`}
          alt=""
        />
      </div>
      ...
      >
        ...
        >
          <img
            ...
            alt="search"
            className={`${isScrolled && "invert"} transition-all duration-500 h-6 w-6`}
          />
        </button>
